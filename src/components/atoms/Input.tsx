...
const Input = forwardRef<HTMLInputElement, HTMLProps<HTMLInputElement>>(
  (props, ref) => {
    ...
    const inputBaseStyle =
      'block h-14 rounded-lg border-[1px] border-solid border-brown p-[16px] placeholder:text-brown3 focus:outline-none focus:ring-1 focus:ring-brown2 bg-transparent';
    return (
      <input
        type={type}
