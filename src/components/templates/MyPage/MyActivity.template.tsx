...
function UserSection({ user }: MyActivityTemplateProps) {
  return (
...
function HouseProfileCard({ user }: MyActivityTemplateProps) {
  return (
...
function UserProfileCard({ user }: MyActivityTemplateProps) {
  return (
    <Container.FlexCol className="rounded-xl bg-brown6 p-8">
